...
public class CourseBook_Dwidol_Basic extends AppCompatActivity {
    ViewPager Dwidol_Basic_Pager;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        Dwidol_Basic_Pager = (ViewPager)findViewById(R.id.basic_pager);
        CourseBook_Basic_Viewpager adapter= new CourseBook_Basic_Viewpager(getLayoutInflater());
        Dwidol_Basic_Pager.setAdapter(adapter);
    }
    public void CourseBook_dwidol_wide(View v){
        Intent CourseBook_Summary_Button_Intent;
        CourseBook_Summary_Button_Intent = new Intent(this,CourseBook_Dwidol_Basic_Wide.class);

        switch (v.getId()){
            case R.id.coursebook_dwidol_button_1:
                CourseBook_Summary_Button_Intent.putExtra("Level","1");
                startActivity(CourseBook_Summary_Button_Intent);
                break;
            case R.id.coursebook_dwidol_button_2:
                CourseBook_Summary_Button_Intent.putExtra("Level","2");
                startActivity(CourseBook_Summary_Button_Intent);
                break;
            case R.id.coursebook_dwidol_button_3:
                CourseBook_Summary_Button_Intent.putExtra("Level","3");
                startActivity(CourseBook_Summary_Button_Intent);
                break;
            case R.id.coursebook_dwidol_button_4:
                CourseBook_Summary_Button_Intent.putExtra("Level","4");
                startActivity(CourseBook_Summary_Button_Intent);
                break;
            case R.id.coursebook_dwidol_button_5:
                CourseBook_Summary_Button_Intent.putExtra("Level","5");
                startActivity(CourseBook_Summary_Button_Intent);
                break;
            case R.id.coursebook_dwidol_button_6:
                CourseBook_Summary_Button_Intent.putExtra("Level","6");
                startActivity(CourseBook_Summary_Button_Intent);
                break;
            case R.id.coursebook_dwidol_button_7:
